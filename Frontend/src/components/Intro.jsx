...
function Intro() {
  ...
  return (
      ...
      (count && <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:3,delay:0.5}} className='bg-neutral-900 min-h-screen w-screen p-6 flex flex-col md:flex-row fixed z-20 justify-center items-center overflow-hidden'>
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          ...
          <motion.img  src={img} className=' block h-[50vh] w-[70vw] md:w-[25vw] rounded-full' />
        </div>
      </motion.div>)
